    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".work__slider")) {
                const swiper = new swiper_core_Swiper(".work__slider", {
                    ...
                    on: {
                        slideChange: function() {
                            const paginationButtons = document.querySelectorAll(".work__control-title span");
        ...
        function windowLoad() {
            ...
            const themeButton = document.querySelector(".header__switch");
        ...
        function textOpacityScroll() {
            ...
            if (items.length) items.forEach((item => {
                const itemValue = item.querySelector(".text");
                const itemMask = item.querySelector(".text__mask");
                const itemSpeed = +itemValue.dataset.textSpeed || 50;
                ...
                if (itemMask) window.addEventListener("scroll", (function() {
                    const maskPosition = itemMask.getBoundingClientRect().top - window.innerHeight;
                    const itemWay = Math.abs(maskPosition) / (window.innerHeight + itemMask.offsetHeight) * 300;
                ...
                function addOpacity(itemWords, currentWord) {
                    itemWords.forEach(((word, index) => {
                        ...
                        if (index <= currentWord) word.style.opacity = 1;
                    }));
                }
            }));
        }
